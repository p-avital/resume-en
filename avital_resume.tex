...
% \item
{\cventry{Feb 2017 -- Aug 2017}{Internship: Connected Vehicules Security}{Pôle Judiciaire de la Gendarmerie Nationale}{Pontoise, France}{}{\vspace{3pt}Starting with the Reverse Engineering of Android applications, the subject evolved towards the use of Software Defined Radios to listen to Bluetooth communications.
...
During BT phase, I modified drivers, firmware and gateware of open source SDR projects to tailor them to the very specific signal processing needs that come with Bluetooth's physical layer and real time computation requirements on wide-band signals.\\\textit{Technologies : Atom, ADB, JDB, GNU Radio, Quartus Prime, FPGA, Gateware, Firmware, DSP, Sans-fil\\Languages : Smali (Java Assembly), JavaScript, Bash, Python, VHDL}}}
